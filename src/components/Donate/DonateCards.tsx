...
export default function DonateCards() {
  ...
  const methodCardClass =
    "group flex flex-col items-start gap-4 rounded-2xl border border-border bg-[var(--glass-t2-bg)] p-8 text-left transition-colors duration-200 hover:border-border-hi focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-ink-deep";

  // Step 2 amount card: single centered card (accent-blue tinted border for brand presence)
  const amountCardClass =
    "mx-auto mt-12 flex max-w-[480px] flex-col rounded-2xl border border-[rgba(61,126,255,0.25)] bg-[var(--glass-t2-bg)] p-6 transition-colors duration-200 hover:border-accent";
  ...
  const chipBase =
    "flex min-h-[44px] items-center justify-center rounded-full border border-border-hi px-3 py-2 text-base font-normal text-text-primary transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-ink-deep";

  // Chip selected modifier (APPLIED in this plan — unlike Phase 11-05)
  const chipSelected =
    "bg-accent/10 border-accent text-text-primary";

  const dividerClass = "my-5 border-t border-border";
  ...
  const ctaEnabledClass =
    "mt-2 flex min-h-[48px] w-full items-center justify-center rounded-full px-6 py-3 text-base font-normal text-white transition-colors duration-200 hover:brightness-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-ink-deep";

  // Disabled CTA — muted surface, no gradient, not-allowed cursor
  const ctaDisabledClass =
    "mt-2 flex min-h-[48px] w-full items-center justify-center rounded-full px-6 py-3 text-base font-normal transition-colors duration-200 cursor-not-allowed";
  ...
  // Back link style
  const backLinkClass =
    "inline-flex items-center gap-1 text-sm text-white-70 transition-colors hover:text-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-ink-deep rounded";
      ...
      <div className="mt-12 mx-auto grid max-w-3xl grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        >
          ...
          <div className="flex flex-col">
            ...
            <p className="text-sm text-white-70">{t("method_fiat_subtitle")}</p>
          </div>
        </button>
  ...
  return (
    <div className={amountCardClass}>
      ...
      <p className="mb-3 text-sm text-white-70">{t("amount_prompt")}</p>
      ...
      <div className="mt-4 flex flex-col gap-2">
        <div className="relative flex min-h-[44px] w-full items-stretch rounded-lg border border-border-hi bg-transparent focus-within:border-accent focus-within:shadow-[0_0_12px_var(--color-glow-soft)]">
          ...
          <input
            ...
            className="w-full flex-1 bg-transparent px-4 text-text-primary placeholder:text-white-70 focus:outline-none"
          />
          <span
            aria-hidden="true"
            className="flex items-center pr-2 text-sm text-white-70"
          >
            €
          </span>
          <div
